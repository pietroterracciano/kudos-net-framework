    ...
    public static class JSONUtils
{
        ...
        public static ObjectType? Deserialize<ObjectType>(dynamic dnm, JsonSerializerOptions? jso = null)
        {
            return ObjectUtils.Cast<ObjectType>(Deserialize(dnm, typeof(ObjectType), jso));
        }
        public static Object? Deserialize(dynamic dnm, Type? t, JsonSerializerOptions? jso = null)
        {
